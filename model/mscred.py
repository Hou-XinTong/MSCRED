...
def attention(ConvLstm_out):
    attention_w = []
    # print('ConvLstm_out',ConvLstm_out.shape) #[[[2,3,4],[6,5,9],[9,7,1],[4,2,0]]] #(1,4,3) #[[1,3],[0,9]] shape (2,2)
    for k in range(5): #[[2,3,4],[6,5,9],[9,7,1],[4,2,0]]
    ...
    # print('convLstmOut',convLstmOut.shape)
    return convLstmOut
...
class CnnDecoder(nn.Module):
    ...
    def forward(self, conv1_lstm_out, conv2_lstm_out, conv3_lstm_out, conv4_lstm_out):
        # print('conv4_lstm_out',conv4_lstm_out.shape)

        # print('conv3_lstm_out',conv3_lstm_out.shape )
        deconv4 = self.deconv4(conv4_lstm_out)
        # print('deconv4', deconv4.shape)
        deconv4_concat = torch.cat((deconv4, conv3_lstm_out), dim = 1)
        # print('deconv4_concat', deconv4_concat.shape)
